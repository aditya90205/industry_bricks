...
// const cities = [
//   { name: "Thiruvananthapuram", image: `${image6}` },
...
//                   />
//                   <h3 className="text-center text-lg font-medium mt-2 pb-1">
//                     {city.name}
//                   </h3>
//                 </div>
//               </div>
...
//         <button className="px-4 py-2 border border-gray-600 text-gray-700 font-martel hover:bg-gray-600 hover:text-white transition-all  rounded-md">
//           All Locations
//         </button>
//       </div>
...
// // Custom arrow components for styling the left and right buttons
// // eslint-disable-next-line react/prop-types
// const CustomPrevArrow = ({ onClick }) => {
//   return (
//     <div
//       onClick={onClick}
//       className="absolute top-1/2 left-[-40px] transform -translate-y-1/2 bg-gray-700 text-white w-12 h-12 flex items-center justify-center rounded-full cursor-pointer hover:bg-gray-900 z-10"
//     >
//       <svg
...
//     <div
//       onClick={onClick}
//       className="absolute top-1/2 right-[-40px] transform -translate-y-1/2 bg-gray-700 text-white w-12 h-12 flex items-center justify-center rounded-full cursor-pointer hover:bg-gray-900 z-10"
//     >
//       <svg
//         xmlns="http://www.w3.org/2000/svg"
//         fill="none"
...
//     slidesToShow: 3,
//     slidesToScroll: 1,
//     autoplay: false, // Autoplay is disabled to meet the requirement
...
//                     src={city.image}
//                     alt={city.name}
//                     className="w-full h-[20rem] lg:h-[34rem] object-cover rounded-lg"
//                   />
//                   <h3 className="text-center text-lg font-medium mt-2 pb-1">
//                     {city.name}
//                   </h3>
