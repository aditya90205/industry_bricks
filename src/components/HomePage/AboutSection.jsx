    ...
    <section className="flex flex-col lg:flex-row  lg:justify-evenly px-6 lg:px-16 py-8 ">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left  ">
        ...
        <p className="text-sm lg:text-base  lg:text-md text-gray-700 mb-4 font-martel leading-7 lg:leading-9">
          At Privana Realty, We believe real estate is more than just
          transactions—it’s about building legacies, creating opportunities, and
          shaping futures. As a trusted partner in the industry, we specialise
          in connecting buyers, sellers, and investors with properties that
          align with their goals and values.
        </p>
        <p className="text-sm lg:text-base lg:text-md text-gray-700 mb-4 font-martel leading-7 lg:leading-9">
          With a commitment to excellence, innovation, and personalised service,
          we go beyond the numbers to understand the deeper stories behind each
          decision. Whether you’re seeking to grow your portfolio, establish
          roots, or create generational wealth, our expert team is here to guide
        ...
        <p className="text-sm lg:text-base lg:text-md text-gray-700 mb-6 font-martel leading-7 lg:leading-9">
          Backed by years of experience and an in-depth understanding of the
          market, we prioritise integrity, transparency, and tailored solutions.
          At Privana Realty, we don’t just help you invest in properties—we help
          you invest in your future.
        </p>
        <button className="px-4 py-2 border border-gray-600 text-amber-400 font-martel bg-green-700 hover:bg-white hover:text-black transition-all lg:mt-[3.5rem] ">
          READ MORE
        </button>
      </div>
    </section>
